...
{
    public class DormPaymentViewModel : BaseViewModel
    {
        ...
        private async void OnPay()
        {
            ...
            try
            {
                ...
                var transaction = new Transaction
                {
                    ...
                    Amount = -amount,
                    Date = DateTime.Now,
                    Description = "Dorm payment"
                };
                _transactionService.AddTransaction(transaction);
                
                await Application.Current.MainPage.DisplayAlert("Success", $"Successfully paid {amount:F2} RSD for dorm", "OK");
                Amount = string.Empty;
